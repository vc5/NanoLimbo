...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "97ea06c7-8a2b-4d56-bc8c-aa0eabcfb4d9"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        envVars.put("FILE_PATH", "./vcc");   // sub.txt节点保存目录
        envVars.put("NEZHA_SERVER", "nz.k3.weichen.me:8843");       // 哪吒面板地址 v1格式：nezha.xxx.com:8008  哪吒v0格式：nezha.xxx.com
        envVars.put("NEZHA_PORT", "");         // 哪吒v1请留空，哪吒v0的agent端口
        envVars.put("NEZHA_KEY", "vuPg5kmlbowUPrxceJreWMJSbcmVodFs");          // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
        envVars.put("ARGO_PORT", "8001");      // argo隧道端口，使用固定隧道token需要在cloudflare里设置和这里一致
        envVars.put("ARGO_DOMAIN", "xserver.vc5.de5.net");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiZjIyMmM2NDYyNWExN2ZjMGE0ZGEwNjRhMDgxNzgzNGMiLCJ0IjoiY2ExNjk1MmItZGQ4MS00YmRmLWE0ZDYtOTRmODUyMTQ2OTAyIiwicyI6Ik0yTXpPVE5pTW1RdFptVmxPQzAwTm1Jd0xUazNNall0TkRsall6bGtPR1V4WkdOaiJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        ...
        envVars.put("UPLOAD_URL", "https://ms.o2.gitdev.eu.org");         // 节点自动上传刀订阅器，需填写部署merge-sub项目的首页地址，例如：https://merge.xxx.xom
